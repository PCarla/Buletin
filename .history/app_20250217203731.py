...
def init_db():
    ...
    """)
   <thinking>
1. The line length issue persists on line 75 in the SQL query.
2. I need to further reformat the SQL query to ensure all lines are within the 79-character limit.
3. I will use the `create_file` tool to overwrite the file with the corrected content.
</thinking>
